...
import { SupabaseCartRepository } from '@/server/infrastructure/supabase/repositories/SupabaseCartRepository';
import { SupabaseCategoryRepository } from '@/server/infrastructure/supabase/repositories/SupabaseCategoryRepository';
import { SupabaseInventoryRepository } from '@/server/infrastructure/supabase/repositories/SupabaseInventoryRepository';
import { SupabaseOrderRepository } from '@/server/infrastructure/supabase/repositories/SupabaseOrderRepository';
import { SupabaseProductRepository } from '@/server/infrastructure/supabase/repositories/SupabaseProductRepository';
import { SupabaseAuthRepository } from '@/server/infrastructure/supabase/repositories/SupabaseAuthRepository';
import { SupabaseLanguageRepository } from '@/server/infrastructure/supabase/repositories/SupabaseLanguageRepository';
import { SupabaseTranslationRepository } from '@/server/infrastructure/supabase/repositories/SupabaseTranslationRepository';
import { SupabaseDashboardRepository } from '@/server/infrastructure/supabase/repositories/SupabaseDashboardRepository';
import { SupabasePaymentRepository } from '@/server/infrastructure/supabase/repositories/SupabasePaymentRepository';
import { IAuthRepository } from '@/server/domain/repositories/IAuthRepository';
import { ResendEmailService } from '@/server/infrastructure/email/ResendEmailService';
import { IEmailService } from '@/server/domain/services/IEmailService';
import { HttpLocationRepository } from '@/server/infrastructure/repositories/HttpLocationRepository';

// Gateways
import { CODPaymentGateway } from '@/server/infrastructure/supabase/gateways/CODPaymentGateway';
import { PayOSGateway } from '@/server/infrastructure/supabase/gateways/PayOSGateway';
import { CompositePaymentGateway } from '@/server/infrastructure/supabase/gateways/CompositePaymentGateway';

// Use Cases - Cart
import { AddToCartUseCase } from '@/server/application/use-cases/cart/AddToCart';
import { MergeCartUseCase } from '@/server/application/use-cases/cart/MergeCart';
import { GetCartUseCase } from '@/server/application/use-cases/cart/GetCart';
import { UpdateCartItemUseCase } from '@/server/application/use-cases/cart/UpdateCartItem';
import { RemoveCartItemUseCase } from '@/server/application/use-cases/cart/RemoveCartItem';

// Use Cases - Category
import { CreateCategoryUseCase } from '@/server/application/use-cases/categories/CreateCategory';
import { DeleteCategoryUseCase } from '@/server/application/use-cases/categories/DeleteCategory';
import { GetCategoriesUseCase } from '@/server/application/use-cases/categories/GetCategories';
import { UpdateCategoryUseCase } from '@/server/application/use-cases/categories/UpdateCategory';

// Use Cases - Orders
import { CreateOrderUseCase } from '@/server/application/use-cases/orders/CreateOrder';
import { GetAllOrdersUseCase } from '@/server/application/use-cases/orders/GetAllOrders';
import { GetOrderDetailUseCase } from '@/server/application/use-cases/orders/GetOrderDetail';
import { GetUserOrdersUseCase } from '@/server/application/use-cases/orders/GetUserOrders';
import { UpdateOrderStatusUseCase } from '@/server/application/use-cases/orders/UpdateOrderStatus';
import { ApproveManualPaymentUseCase } from '@/server/application/use-cases/orders/ApproveManualPayment';
import { SendOrderConfirmationEmailUseCase } from '@/server/application/use-cases/orders/SendOrderConfirmationEmail';
import { GetUserPurchasedTemplatesUseCase } from '@/server/application/use-cases/orders/GetUserPurchasedTemplates';
import { CheckProductPurchasedUseCase } from '@/server/application/use-cases/orders/CheckProductPurchased';

// Use Cases - Products
import { CreateProductUseCase } from '@/server/application/use-cases/products/CreateProduct';
import { UpdateProductUseCase } from '@/server/application/use-cases/products/UpdateProduct';
import { DeleteProductUseCase } from '@/server/application/use-cases/products/DeleteProduct';
import { GetProductByIdUseCase } from '@/server/application/use-cases/products/GetProductById';
import { GetProductsUseCase } from '@/server/application/use-cases/products/GetProducts';

// Use Cases - Translations & Languages
import { AddTranslationUseCase } from '@/server/application/use-cases/translations/AddTranslation';
import { UpdateTranslationUseCase } from '@/server/application/use-cases/translations/UpdateTranslation';
import { DeleteTranslationUseCase } from '@/server/application/use-cases/translations/DeleteTranslation';
import { GetTranslationsUseCase } from '@/server/application/use-cases/translations/GetTranslations';
import { GetPaginatedTranslationsUseCase } from '@/server/application/use-cases/translations/GetPaginatedTranslations';
import { SyncTranslationsUseCase } from '@/server/application/use-cases/translations/SyncTranslations';
import { GetLanguagesUseCase } from '@/server/application/use-cases/languages/GetLanguages';
import { SetDefaultLanguageUseCase } from '@/server/application/use-cases/languages/SetDefaultLanguage';

// Use Cases - Admin
import { GetDashboardMetricsUseCase } from '@/server/application/use-cases/admin/GetDashboardMetrics';
import { GetAdminCustomersUseCase } from '@/server/application/use-cases/admin/GetAdminCustomers';

// Use Cases - Payment
import { ProcessPaymentUseCase } from '@/server/application/use-cases/payment/ProcessPayment';
import { HandlePayOSWebhookUseCase } from '@/server/application/use-cases/payment/HandlePayOSWebhook';
import { VerifyOrderPaymentUseCase } from '@/server/application/use-cases/payment/VerifyOrderPayment';

// Use Cases - Auth
import { LoginUseCase } from '@/server/application/use-cases/auth/LoginUseCase';
import { SignupUseCase } from '@/server/application/use-cases/auth/SignupUseCase';
import { VerifyOtpUseCase } from '@/server/application/use-cases/auth/VerifyOtpUseCase';
import { ResendOtpUseCase } from '@/server/application/use-cases/auth/ResendOtpUseCase';
import { SignoutUseCase } from '@/server/application/use-cases/auth/SignoutUseCase';
import { ForgotPasswordUseCase } from '@/server/application/use-cases/auth/ForgotPasswordUseCase';
import { UpdatePasswordUseCase } from '@/server/application/use-cases/auth/UpdatePasswordUseCase';
import { ChangePasswordUseCase } from '@/server/application/use-cases/auth/ChangePasswordUseCase';
import { UpdateProfileUseCase } from '@/server/application/use-cases/auth/UpdateProfileUseCase';
import { GetCustomerCheckoutInfoUseCase } from '@/server/application/use-cases/auth/GetCustomerCheckoutInfo';
import { GetCurrentUserUseCase } from '@/server/application/use-cases/auth/GetCurrentUser';
import { GetProfileUseCase } from '@/server/application/use-cases/auth/GetProfile';
